...
Applying the linear model to our left out dataset from our initial split was much faster (took only `r round(lin_final_time, 2)` seconds to run!) compared to our 10-fold cv training data (`r round(lin_time, 2)` min) where the model was fitted across multiple folds. It should be mentioned that overall the linear model was extremely quick to run computationally as there were no tuning involved at the most basic level.   
